...
@pytest.mark.parametrize(
    ...
    [
        (
            ExecutionPolicy(denied_executables=frozenset({"python"})),
            CommandSpec("python", ()),
            1,
            1,
            "denied_executables",
        ...
        (
            ExecutionPolicy(allowed_executables=frozenset({"git"})),
            CommandSpec("python", ()),
            1,
            1,
            "allowed_executables",
        ...
        (
            ExecutionPolicy(require_absolute_executable=True),
            CommandSpec("python", ()),
            1,
            1,
        ...
        (
            ExecutionPolicy(require_timeout=True),
            CommandSpec("python", ()),
            None,
            1,
            "require_timeout",
        ...
        (
            ExecutionPolicy(max_timeout_ms=10),
            CommandSpec("python", ()),
            11,
            1,
            "max_timeout_ms",
        ...
        (
            ExecutionPolicy(max_output_bytes=10),
            CommandSpec("python", ()),
            1,
            11,
            "max_output_bytes",
        ...
        (
            ExecutionPolicy(allow_parent_environment=False),
            CommandSpec("python", ()),
            1,
            1,
        ...
        (
            ExecutionPolicy(allowed_env_keys=frozenset({"SAFE"})),
            CommandSpec("python", (), env={"SECRET": "x"}),
            1,
            1,
            "allowed_env_keys",
        ),

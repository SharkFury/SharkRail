...
| Local state disclosure | Strict config/secret permissions, protected Windows DACLs, and private database/output files | Protect backups and the service account itself |

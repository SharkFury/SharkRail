...
- [Reliable asynchronous jobs](ASYNC_JOBS.md): proposed self-hosted client/server
  execution, persistence, recovery, and notification design
- [可靠异步任务架构](ASYNC_JOBS.zh-CN.md)：自托管 C/S 执行与回调方案
